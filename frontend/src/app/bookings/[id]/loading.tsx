    ...
    <div className="relative min-h-screen bg-[#0C0A09] py-12">
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <div className="h-6 w-44 bg-orange-500/10 rounded-full border border-orange-500/20 mx-auto mb-3 skeleton-shimmer" />
        ...
        {/* BookingDetailClient space-y-8 wrapper */}
        <div className="space-y-8">
          ...
          <div className="rounded-3xl border border-dashed border-orange-500/30 bg-[#171310]/30 p-6 sm:p-8 backdrop-blur-xl">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
              ...
              <div className="h-12 w-40 bg-orange-500/10 rounded-xl border border-orange-500/15 shrink-0 skeleton-shimmer" />
            </div>
          </div>
        </div>
      </div>
